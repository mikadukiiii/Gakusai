...
class MetadataResolver {
  ...
  public static int findUrlMetadata(Context context,
    ...
    initialize(context);
    int bytes = requestUrlMetadata(url, txPower, rssi);
   ...
   */
  private static int requestUrlMetadata(String url, int txPower, int rssi) {
    if (!mIsInitialized) {
